...
test("server-renders the concept-first course", async () => {
  ...
  assert.match(html, /Let’s make your current model/);
  assert.match(html, /Lesson progress/);
...
test("ships course metadata and removes the starter preview", async () => {
  ...
  assert.match(page, /localStorage\.setItem\("cfp-lesson-1"/);
